...
Lytebox.prototype.showContent = function() {
	if (this.isSlideshow) {
		...
		this.doc.$('lbClose').style.display = (this.showClose && !this.navTop ? '' : 'block');
		...
		this.doc.$('lbCloseTop').style.display = (this.navTop ? '' : 'block');
...
Lytebox.prototype.updateDetails = function() {
	...
	this.doc.$('lbBottomContainer').style.display = (!(this.titleTop && this.navTop) || !this.isEmpty(sDesc) ? 'none' : 'block');
	if (this.titleTop && this.navTop) {
		if (iNavWidth > 0) {
