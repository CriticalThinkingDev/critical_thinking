 ...
 * Last Modified: 2017-04-06T21:45:50+02:00
                ...
                if (isset($actionData['class']) && isset($actionData['method'])) {
                    ...
                    if ($actionModel) {
                        try {
                            ...
                            $order = $this->loadOrder($rowIdentifier);
                            #return $this->_returnDebugResult($importChanged, $importDebugMessages); // Uncomment this line to STOP order processing on exception (example: failed invoicing/capturing)
                            continue;
                        }
                    }
                }
