 ...
 * Last Modified: 2017-07-11T15:13:47+02:00
...
class Xtento_TrackingImport_Model_Import extends Mage_Core_Model_Abstract
{
    ...
    public function cronImport()
    {
        ...
        if (empty($importResult) && $this->getLogEntry()->getResult() === Xtento_TrackingImport_Model_Log::RESULT_SUCCESSFUL) {
    ...
    private function _loadFiles()
    {
        ...
        Mage::dispatchEvent('xtento_trackingimport_files_load_after', array('transport' => $transportObject));
