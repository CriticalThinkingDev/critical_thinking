 ...
 * Last Modified: 2016-03-08T11:27:55+01:00
    ...
    public function saveAction()
    {
        if ($postData = $this->getRequest()->getPost()) {
            ...
            if ($model->getId()) {
                ...
                if ($model->getType() == Xtento_TrackingImport_Model_Source::TYPE_FTP || $model->getType() == Xtento_TrackingImport_Model_Source::TYPE_SFTP) {
                    #$model->setPath('/' . ltrim($model->getPath(), '/')); // Prefix with /
                }
            }
