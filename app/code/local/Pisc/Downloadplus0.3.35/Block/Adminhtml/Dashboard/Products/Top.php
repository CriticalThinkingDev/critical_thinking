...
class Pisc_Downloadplus_Block_Adminhtml_Dashboard_Products_Top extends Mage_Adminhtml_Block_Dashboard_Grid
{
    ...
    {
        parent::__construct();
        $this->setId('topDownloadProductsGrid');
    }
    ...
    public function getRowUrl($row)
    {
    	if ($row->getProductId()) {
	        ...
	        return $this->getUrl('administrator/catalog_product/edit', $params);
    	}
    	return false;
    }
