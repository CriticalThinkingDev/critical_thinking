	...
	public function _prepareForm()
	{
		...
		$fieldset->addField('downloadplus-serialnumberpool-new', 'text',
			array(
				...
				'value' => '',
				'required' => false,
				'after_element_html' => '<p class="note nm"><small>'.$this->__("Leave empty when importing globally to all stores.").'</small></p>'
			)
		);
		...
		$form->setAction($this->getUrl('downloadplusadmin/serialnumber/importPost'));
