    ...
    */
	 ...
	 */
	 ...
	 public function getCatalogProductDefaultExpiryType($type) {
	 	...
	 	switch ($type) {
	 		case 'file':
	 			$result = Mage::getStoreConfig(self::CONFIG_XML_PATH_CATALOG_PRODUCT_DEFAULT_EXPIRY_TYPE_FILE);
	 			break;
	 		case 'url':
	 			$result = Mage::getStoreConfig(self::CONFIG_XML_PATH_CATALOG_PRODUCT_DEFAULT_EXPIRY_TYPE_URL);
	 			break;
	 		case 'aws-s3':
	 			$result = Mage::getStoreConfig(self::CONFIG_XML_PATH_CATALOG_PRODUCT_DEFAULT_EXPIRY_TYPE_AWSS3);
	 			break;
	 		case 'aws-cf':
	 			$result = Mage::getStoreConfig(self::CONFIG_XML_PATH_CATALOG_PRODUCT_DEFAULT_EXPIRY_TYPE_AWSCF);
	 			break;
	 	}
	 	return $result;
	 }
	 public function getCatalogProductDefaultExpiryDuration($type) {
	 	...
	 	switch ($type) {
	 		case 'file':
	 			$result = Mage::getStoreConfig(self::CONFIG_XML_PATH_CATALOG_PRODUCT_DEFAULT_EXPIRY_DURATION_FILE);
	 			break;
	 		case 'url':
	 			$result = Mage::getStoreConfig(self::CONFIG_XML_PATH_CATALOG_PRODUCT_DEFAULT_EXPIRY_DURATION_URL);
	 			break;
	 		case 'aws-s3':
	 			$result = Mage::getStoreConfig(self::CONFIG_XML_PATH_CATALOG_PRODUCT_DEFAULT_EXPIRY_DURATION_AWSS3);	 			
	 			break;
	 		case 'aws-cf':
	 			$result = Mage::getStoreConfig(self::CONFIG_XML_PATH_CATALOG_PRODUCT_DEFAULT_EXPIRY_DURATION_AWSCF);
	 			break;
	 	}
	 	return $result;
	 }
