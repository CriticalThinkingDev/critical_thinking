    		...
    		if (isset($data['sample'])) {
    			...
    			foreach ($data['sample'] as $sampleItem) {
    				if ($sampleItem['is_delete'] == '1') {
    					...
    					if ($sampleModel->getSampleType() == Pisc_Downloadplus_Helper_Download::LINK_TYPE_AWSS3 && isset($sampleItem['amazon_s3_bucket']) && isset($sampleItem['amazon_s3_file'])) {
    						$sampleModel->setSampleUrl($sampleItem['amazon_s3_bucket'].'|'.$sampleItem['amazon_s3_file']);
    					}
    					if ($sampleModel->getSampleType() == Pisc_Downloadplus_Helper_Download::LINK_TYPE_AWSS3 && isset($sampleItem['amazon_s3_object'])) {
   							$sampleModel->setSampleUrl($sampleItem['amazon_s3_object']);
    					}

    					if ($sampleModel->getSampleType() == Pisc_Downloadplus_Helper_Download::LINK_TYPE_AWSCF && isset($sampleItem['amazon_cf_object'])) {
    			...
    			foreach ($data['link'] as $linkItem) {
    				if ($linkItem['is_delete'] == '1') {
    					...
    					if ($sample && isset($sample['type'])) {
    						...
    						if ($sample['type']==Pisc_Downloadplus_Helper_Download::LINK_TYPE_AWSS3 && isset($sample['amazon_s3_bucket']) && isset($sample['amazon_s3_file'])) {
    						...
    						if ($sample['type']==Pisc_Downloadplus_Helper_Download::LINK_TYPE_AWSCF && isset($sample['amazon_cf_object'])) {
    					...
    					if ($linkModel->getLinkType() == Pisc_Downloadplus_Helper_Download::LINK_TYPE_AWSS3 && isset($linkItem['amazon_s3_bucket']) && isset($linkItem['amazon_s3_file'])) {
    					...
    					if ($linkModel->getLinkType() == Pisc_Downloadplus_Helper_Download::LINK_TYPE_AWSCF && isset($linkItem['amazon_cf_object'])) {
