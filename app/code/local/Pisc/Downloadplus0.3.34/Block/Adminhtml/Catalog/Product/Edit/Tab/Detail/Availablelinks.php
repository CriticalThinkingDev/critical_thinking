...
class Pisc_Downloadplus_Block_Adminhtml_Catalog_Product_Edit_Tab_Detail_Availablelinks extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        parent::__construct();
        $this->setId('availableDownloadableLinkFilesGrid');
