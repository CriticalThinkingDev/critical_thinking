...
class Pisc_Downloadplus_Block_Adminhtml_Catalog_Product_Edit_Tab_Detail_Availablelinksamples extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        parent::__construct();
        $this->setId('availableDownloadableLinkSampleFilesGrid');
    ...
    protected function _prepareCollection()
    {
    	...
    	$collection = Mage::getModel('downloadplus/download_detail')->getCollection()
    						...
    						->getAvailablePhysicalLinkSampleFiles();
