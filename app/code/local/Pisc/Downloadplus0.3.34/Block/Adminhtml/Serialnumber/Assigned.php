...
class Pisc_Downloadplus_Block_Adminhtml_Serialnumber_Assigned extends Mage_Adminhtml_Block_Widget_Grid_Container
{
	/*
	 * Constructor
	 */
	...
	{
		$this->_controller = 'adminhtml_serialnumber_assigned';
