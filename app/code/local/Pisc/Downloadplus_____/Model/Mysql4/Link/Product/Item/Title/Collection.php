...
/**
 * Downloadable additional product links extension resource collection
 *
 * @category    Pisc
 * @package     Pisc_Downloadplus
...
class Pisc_Downloadplus_Model_Mysql4_Link_Product_Item_Title_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    public function getUniqueTitles()
    {
    	$sql = $this->getSelect()
    				->reset()
    				->distinct()
    				->from(array('main_table'=>$this->getTable('downloadplus/link_product_item_title')), array('title'));
