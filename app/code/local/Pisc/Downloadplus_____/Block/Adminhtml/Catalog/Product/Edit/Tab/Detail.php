...
class Pisc_Downloadplus_Block_Adminhtml_Catalog_Product_Edit_Tab_Detail extends Mage_Adminhtml_Block_Template implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
	...
	{
		return $this->getUrl('adminhtml/product_edit/downloadDetail', array('_current' => true));
	}
	...
	protected function _toHtml()
	{
		...
		$accordion->addItem('add_historical_link_files', array(
            'title'   => 'Links',
            'ajax'	  		=> true,
			'content_url'	=> $this->getUrl('adminhtml/product_edit/viewAvailableLinks', array('_current' => true)),
		...
		$accordion->addItem('add_historical_linksample_files', array(
            'title'   => 'Link Samples',
	        'ajax'	  		=> true,
			'content_url'	=> $this->getUrl('adminhtml/product_edit/viewAvailableLinksamples', array('_current' => true)),
		...
		$accordion->addItem('add_historical_sample_files', array(
            'title'   => 'Samples',
	        'ajax'	  		=> true,
			'content_url'	=> $this->getUrl('adminhtml/product_edit/viewAvailableSamples', array('_current' => true)),
