...
class Pisc_Downloadplus_Block_Download_Links_Archive extends Mage_Core_Block_Template
{
	...
	function getDetail()
	{
		...
		if ($this->_link && $this->_link->getLinkId()) {
			$result = Mage::getModel('downloadplus/download_detail')->loadByLinkId($this->_link->getLinkId());
		}
		return $result;
	}
