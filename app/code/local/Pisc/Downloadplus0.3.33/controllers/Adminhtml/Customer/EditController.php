...
class Pisc_Downloadplus_Adminhtml_Customer_EditController extends Mage_Adminhtml_CustomerController
{
    ...
    public function viewPurchasedDownloadsAction()
    {
        ...
        $this->getResponse()->setBody(
            $this->getLayout()
            	->createBlock('downloadplus/adminhtml_customer_edit_tab_downloads_purchasedlinks', 'admin.customer.view.downloadplus.currentDownloads')
                ->toHtml()
        );
    }
