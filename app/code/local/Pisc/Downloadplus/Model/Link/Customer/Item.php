...
class Pisc_Downloadplus_Model_Link_Customer_Item extends Mage_Downloadable_Model_Link_Purchased_Item
{
    ...
    {
    	return Mage::getModel('downloadplus/customer_download')->getBaseTmpPath($this->getCustomer());
    }
    
    public function getBasePath()
    {
    	return Mage::getModel('downloadplus/customer_download')->getBasePath($this->getCustomer());
    }
