...
class Pisc_Downloadplus_Model_Link_Product_Item extends Mage_Core_Model_Abstract
{
    ...
    {
		return Mage::getModel('downloadplus/product_download')->getBaseTmpPath($this->getProduct());    	
    }
    
    public function getBasePath()
    {
    	return Mage::getModel('downloadplus/product_download')->getBasePath($this->getProduct());
    }
    ...
    public function getAttributes($raw=false)
    {
    	...
    	if ($raw) {
    		...
    		if ($this->getProductId()) {
    			...
    			$availableAttributes = Mage::helper('downloadplus')->getCustomDownloadableAttributes($product, 'additional');
	    	...
	    	$product = Mage::getModel('catalog/product')->load($this->getProductId());
	    	$attributes = Mage::app()->getHelper('downloadplus')->getCustomDownloadableAttributes($product, 'additional');
