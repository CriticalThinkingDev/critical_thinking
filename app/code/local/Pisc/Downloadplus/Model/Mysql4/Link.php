...
class Pisc_Downloadplus_Model_Mysql4_Link extends Mage_Downloadable_Model_Mysql4_Link
{
    /**
    ...
    {
        parent::_construct();
        $this->_init('downloadplus/link', 'link_id');
    }
    ...
    {
        Mage::dispatchEvent('downloadplus_link_delete_items', Array('items'=>$items));
