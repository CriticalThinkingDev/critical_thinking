...
class Pisc_Downloadplus_Block_Adminhtml_Customer_Edit_Tab_Downloads extends Mage_Adminhtml_Block_Template implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _construct()
    {
        ...
        if (!Mage::helper('downloadplus')->isFlashUploader()) {
		   $this->setTemplate('downloadplus/customer/edit/downloads-html5.phtml');
        }
    }
    ...
    {
        return $this->getUrl('adminhtml/downloadplus_customer_edit/currentDownloads', array('_current' => true));
    }
	...
	protected function _toHtml()
	{
		...
		$accordion->addItem('downloadplus_customer_downloads_log', array(
			'title'   => 'Downloads logged for this Customer',
			'content' => $this->getLayout()->createBlock('downloadplus/adminhtml_customer_edit_tab_downloads_log')->toHtml(),
			'open'    => false
		));
