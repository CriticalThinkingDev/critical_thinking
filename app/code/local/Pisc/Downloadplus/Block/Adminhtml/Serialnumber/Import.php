...
class Pisc_Downloadplus_Block_Adminhtml_Serialnumber_Import extends Mage_Adminhtml_Block_Widget_Form_Container
{
	...
	public function __construct()
	{
	    ...
	    $this->setData('form_action_url', $this->getUrl('adminhtml/downloadplus_serialnumber/importPost', Array('_secure'=>true)));
	    ...
	    $this->_addButton('available', array(
	    	...
	    	'onclick'   => 'window.location.href=\'' . $this->getUrl('adminhtml/downloadplus_serialnumber/available/') . '\'',
	    	'class'     => ''
	    ));
