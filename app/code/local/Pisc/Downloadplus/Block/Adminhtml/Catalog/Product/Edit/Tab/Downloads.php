...
class Pisc_Downloadplus_Block_Adminhtml_Catalog_Product_Edit_Tab_Downloads extends Mage_Adminhtml_Block_Template implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _construct()
    {
		...
		if (!Mage::helper('downloadplus')->isFlashUploader()) {
		    $this->setTemplate('downloadplus/product/edit/downloads-html5.phtml');
		}
    }
    ...
    */
    ...
    {
        return $this->getUrl('adminhtml/downloadplus_product_edit/additionalDownloads', array('_current' => true));
    }
    */
