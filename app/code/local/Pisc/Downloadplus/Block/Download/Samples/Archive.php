...
class Pisc_Downloadplus_Block_Download_Samples_Archive extends Mage_Core_Block_Template
{
	...
	function getDetail()
	{
		...
		if ($this->_link && $this->_link->getLinkId()) {
			$result = Mage::getModel('downloadplus/download_detail')->loadBySampleId($this->_sample->getSampleId());
		}
		return $result;
	}
