...
CREATE TABLE IF NOT EXISTS {$this->getTable('downloadplus_download_detail')} (
  ...
  `link_bonus_item_id` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS {$this->getTable('downloadplus_link_extension')} (
  ...
  serial_number_pool varchar(255) DEFAULT NULL,
  serial_number_pool_unlock varchar(255) DEFAULT NULL,
  attributes text,
  PRIMARY KEY (id),
...
CREATE TABLE IF NOT EXISTS {$this->getTable('downloadplus_link_purchased_item_extension')} (
  ...
  `attributes` text,
  `unlock_serial_number` text,
  `unlock_serial_number_hash` varchar(255) DEFAULT NULL,  
  PRIMARY KEY (`id`),
...
if ($attribute = $setup->getAttribute('catalog_product','downloadplus_serialnr_inactive')) {
