...
class AW_Marketsuite_Model_Filter_Mag18 extends AW_Marketsuite_Model_Filter
{
    /**
    ...
    {
        if (!$ruleId) return Mage::getResourceModel('sales/order_grid_collection');
        ...
        $collection->getSelect()
            ->where('find_in_set(main_table.entity_id, "'.implode(',',$matchesArray).'")');
