<?php
require_once(getcwd().'/app/code/core/Mage/Review/controllers/ProductController.php');
class Krishinc_Reviews_ProductController extends Mage_Review_ProductController
{
    ...
    { 
        ...
        if (($product = $this->_initProduct()) && !empty($data)) {
            ...
            if ($validate === true) {
                    ...
                    try {
                        $validatecaptcha = $this->_isValideCaptcha();
			$validatecaptcha = 1;
                        if($validatecaptcha)
                        {
