...
class Krishinc_Offerlanding_Block_Adminhtml_Offerlanding_Customgrid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
    ...
    $this->addColumn('address2', array(
     ...
     $this->addColumn('city', array(
          'header'    => Mage::helper('offerlanding')->__('City'),
          'align'     =>'left',
          'index'     => 'city',
      ));  
    ...
    $this->addColumn('zipcode', array(
  	...
  	$this->addColumn('phone', array(
          'header'    => Mage::helper('offerlanding')->__('Telephone'),
          'align'     =>'left',
          'index'     => 'phone',
      )); 
   
   	$this->addColumn('best_describe', array(
          'header'    => Mage::helper('offerlanding')->__('Best Describe'),
          'align'     =>'left',
          'index'     => 'best_describe',
      ));
