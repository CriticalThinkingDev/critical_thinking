 ...
 * @package Krishinc_Customlinks
 */
class Krishinc_Customlinks_Block_Product_List_Componentsold extends Mage_Catalog_Block_Product_Abstract
{
    /**
    ...
    protected function _prepareData()
    {
        ...
        $this->_itemCollection = $product->getComponentsoldProductCollection()
            ->setPositionOrder()
            ->addStoreFilter()
        ;
...
//        Mage::getSingleton('catalog/product_status')->addSaleableFilterToCollection($this->_itemCollection);
        ...
        if ($this->getItemLimit('componentsold') > 0) {
            $this->_itemCollection->setPageSize($this->getItemLimit('componentsold'));
        }
         ...
         */
        Mage::dispatchEvent('catalog_product_componentsold', array(
            'product'       => $product,
    ...
    /**
     * Set how many items we need to show in componentsold block
