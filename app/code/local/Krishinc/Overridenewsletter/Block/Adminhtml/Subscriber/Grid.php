 ...
 */
class Krishinc_Overridenewsletter_Block_Adminhtml_Subscriber_Grid extends Mage_Adminhtml_Block_Newsletter_Subscriber_Grid
{ 
...
//        ));
		...
		$this->addColumn('firstname', array(
            'header'    => Mage::helper('newsletter')->__('Customer First Name'),
            'index'     => (('firstname')?'firstname':'customer_firstname'),
            'default'   =>    '----' 
        ));

        $this->addColumn('lastname', array(
            'header'    => Mage::helper('newsletter')->__('Customer Last Name'),
            'index'     => (('lastname')?'lastname':'customer_lastname'),  
            'default'   =>    '----'
        ));
 		$this->addColumn('position', array(
            'header'    => Mage::helper('newsletter')->__('Position'),
            'index'     => 'position',
            'default'   =>    '----'
        ));
