 ...
 * @author   Ktpl
 */
class Krishinc_Hardcoder_Block_Adminhtml_Hardcoder_Edit_Tab_Associatedproducts extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        parent::__construct();
        $this->setId('hardcoderd_product_grid');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('position', array(
            ...
            'renderer' => new Krishinc_Hardcoder_Block_Renderer_Position,
            'index'             => 'position',
            'editable'          => true,
            'edit_only'         => true
        ));
