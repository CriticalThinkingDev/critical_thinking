...
class Krishinc_Ebooksubscribe_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    public function subscribe1Action(){
        $this->loadLayout();
        $this->renderLayout();
    }

    public function subscribe2Action(){
        $this->loadLayout();
        $this->renderLayout();
    }
...
//	    			{
                ...
                $url = Mage::getUrl('').'free-ebook-download1';
...
//			    			}
    ...
    public function createpost2Action()
    {
        if($data = $this->getRequest()->getPost())
        {
            // p($data);
...
//	    			{
                ...
                $url = Mage::getUrl('').'free-ebook-download2';
                $this->_redirectUrl($url);
                return;
//						  	} else {
//			    				$this->_getSession()->addError(Mage::helper('captcha')->__('Email Address Already Exists!'));
