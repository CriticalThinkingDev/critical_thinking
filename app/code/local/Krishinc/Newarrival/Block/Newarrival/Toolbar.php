...
class Krishinc_Newarrival_Block_Newarrival_Toolbar extends Mage_Core_Block_Template
{
   /**
     * Products collection
     *
    ...
    protected function _getAvailableLimit($mode)
    {
        ...
        if (Mage::getStoreConfigFlag('catalog/frontend/list_allow_all')) {
            return ($perPageValues + array('all'=>$this->__('See All')));
        } else {
    ...
    {
        $pagerBlock = $this->getChild('newarrival_toolbar_pager');
