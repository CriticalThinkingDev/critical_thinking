...
class Krishinc_Fieldtester_Block_Adminhtml_Fieldtester_Customgrid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
    ...
    $this->addColumn('address2', array(
     ...
     $this->addColumn('city', array(
          'header'    => Mage::helper('fieldtester')->__('City'),
          'align'     =>'left',
          'index'     => 'city',
      ));   
  	$this->addColumn('region', array(
          'header'    => Mage::helper('fieldtester')->__('Region'),
          'align'     =>'left',
          'index'     => 'region',
	      'type'      =>'region',
	      'renderer'  => 'offerlanding/renderer_region', 
      ));
    $this->addColumn('country_id', array(
  	...
  	$this->addColumn('phone', array(
          'header'    => Mage::helper('fieldtester')->__('Telephone'),
          'align'     =>'left',
          'index'     => 'phone',
      )); 
      
      $this->addColumn('best_describe', array(
          'header'    => Mage::helper('fieldtester')->__('Best Describe'),
          'align'     =>'left',
          'index'     => 'best_describe',
      ));
