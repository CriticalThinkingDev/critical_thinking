...
class Krishinc_Advancecustomer_Block_Adminhtml_Edit_Tab_Addresses extends Mage_Adminhtml_Block_Customer_Edit_Tab_Addresses 
{
	 /**
    ...
    public function initForm()
    {
        ...
        if ($cityElement) {
            $cityElement->addClass('validate-length maximum-length-30'); 
        }
