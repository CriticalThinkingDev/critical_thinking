...
class Krishinc_Advancecustomer_Block_Adminhtml_Customer_Edit_Tab_Account extends Mage_Adminhtml_Block_Customer_Edit_Tab_Account
{
...
//        }
	...
	// Prepare send welcome email checkbox
            $fieldset->addField('subscription', 'checkbox', array(
            ...
            $form->getElement('subscription')->setAfterElementHtml(
                    '<script type="text/javascript">'
                . "                
                var myChoice = '1';
                ...
                if(document.getElementById('_accountwebsite_id').value==1)       
                {
                    $('_accountsendemail').disabled = false;
                    $('_accountsendemail').checked = true;
                }
                "
                . '</script>'
                    ); 
