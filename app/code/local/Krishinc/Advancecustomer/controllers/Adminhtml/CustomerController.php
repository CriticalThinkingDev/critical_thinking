...
class Krishinc_Advancecustomer_Adminhtml_CustomerController extends Mage_Adminhtml_CustomerController 
{
            ...
            try {
                foreach ($customersIds as $customerId) {
                    ...
                    Mage::dispatchEvent('overridenewsletter_subscriber_save_after',
		                array('subscriber' => Mage::getModel('newsletter/subscriber')->loadByEmail($customer->getEmail()))
		            );   
                }
 ...
 /**
     * ***For Nomail i.e. Do Not Mail field
     */
     /**
    ...
    public function saveAction()
    {
        ...
        if ($data) {
            ...
            try {
                ...
                $customer->setStoreId(Mage::app()->getWebsite($customer->getWebsiteId())->getDefaultStore()->getId());
                $customer->save();
