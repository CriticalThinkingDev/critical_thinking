...
class Krishinc_Catalogrequest_Block_Adminhtml_Catalogrequest_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
    ...
    $this->addColumn('zipcode', array(
 	...
 	$this->addColumn('export_at', array(
          'header'    => Mage::helper('catalogrequest')->__('Export Time'),
          'align'     =>'left',
          'index'     => 'export_at',
          'type'	  => 'datetime'
      ));
  	$this->addColumn('is_export', array(
          'header'    => Mage::helper('catalogrequest')->__('Is Export'),
          'align'     =>'left',
          'index'     => 'is_export',
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('status', array(
             'label'=> Mage::helper('softwaredemos')->__('Change Export status'),
             'url'  => $this->getUrl('*/*/massExportStatus', array('_current'=>true)),
             'additional' => array(
                    'visibility' => array(
                         'name' => 'is_export',
                         'type' => 'select',
