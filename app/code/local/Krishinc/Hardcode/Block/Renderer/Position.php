...
class Krishinc_Hardcode_Block_Renderer_Position extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    ...
    public function render(Varien_Object $row)
    {
        ...
        $content = Mage::getModel('hardcode/hardcode')->load($id)->getContent();
