...
class Krishinc_Dealerskit_Block_Adminhtml_Dealerskit_Customgrid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
    ...
    $this->addColumn('attention', array(
      ...
      $this->addColumn('city', array(
          'header'    => Mage::helper('dealerskit')->__('City'),
          'align'     =>'left',
          'index'     => 'city',
      ));   
   ...
   $this->addColumn('zipcode', array(
     ...
     $this->addColumn('phone', array(
          'header'    => Mage::helper('dealerskit')->__('Telephone'),
          'align'     =>'left',
          'index'     => 'phone',
      ));  
     
    $this->addColumn('listrak_response', array(
          'header'    => Mage::helper('dealerskit')->__('ListrakResponse'),
          'align'     =>'left',
          'index'     => 'listrak_response',
      ));  
