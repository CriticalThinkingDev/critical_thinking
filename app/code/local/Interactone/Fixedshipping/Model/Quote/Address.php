...
class Interactone_Fixedshipping_Model_Quote_Address
    extends Mage_Sales_Model_Quote_Address
{
    ...
    public function requestShippingRates(Mage_Sales_Model_Quote_Item_Abstract $item = null)
    {
        ...
        $request->setFixedShippingAmount($this->getFixedShippingAmount());
        ...
        if ($result) {
            ...
            foreach ($shippingRates as $shippingRate ){///* @var $shippingRate Mage_Shipping_Model_Rate_Result_Method */) {
