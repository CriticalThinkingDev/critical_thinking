 ...
 */
class Interactone_Fixedshipping_Block_Adminhtml_System_Config_Form_Field_Premiumraterequired
    extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected $_method  = 'premiumrate';
    protected $_display = 'Webshopapps_Premiumrate';
	 /**
	    ...
	    {
	        if (!Mage::helper('interactone_common')->isModuleInstalled('Webshopapps_Premiumrate')) {
	            $element->setDisabled('disabled')
	                ->setValue(0)
	                ->setComment('Webshopapps_Premiumrate module required.');
	        } else {
	            if (!Mage::helper('interactone_common')->isModuleEnabled('Webshopapps_Premiumrate')) {
	                $element->setDisabled('disabled')
	                    ->setValue(0)
	                    ->setComment('Webshopapps_Premiumrate module must be enabled.');
	            } else {
