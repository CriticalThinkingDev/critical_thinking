...
/* */
    ...
    {
		$_tempBilling =  Mage::getSingleton('checkout/session')->getTempBilling();
        $_tempShipping =  Mage::getSingleton('checkout/session')->getTempShipping();
        $countryId = $this->getAddress()->getCountryId();
        if($type=='billing' && count($_tempBilling)){
            $countryId = $_tempBilling['country_id'];
        }
        if($type=='shipping' && count($_tempShipping)){
            $countryId = $_tempShipping['country_id'];
        }
        ...
        $select = $this->getLayout()->createBlock('core/html_select')
            ...
            ->setClass('validate-select browser-default')
            ->setValue($countryId)
