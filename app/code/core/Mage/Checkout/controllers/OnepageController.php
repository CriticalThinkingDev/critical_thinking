...
$sendtoListrak = false;
 ...
 Mage::getSingleton('checkout/session')->unsIsjoinemaillist();
                ...
                Mage::getSingleton('checkout/session')->setIsjoinemaillist($sendtoListrak);
			 Mage::getSingleton('checkout/session')->setTempBilling($data);
  ...
  if ($this->isFormkeyValidationOnCheckoutEnabled() && !$this->_validateFormKey()) {		
        ...
        if ($this->getRequest()->isPost()) {
            $data = $this->getRequest()->getPost('shipping', array());
			 Mage::getSingleton('checkout/session')->setTempShipping($data);
