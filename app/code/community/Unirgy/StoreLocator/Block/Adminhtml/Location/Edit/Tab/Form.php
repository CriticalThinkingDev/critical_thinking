...
class Unirgy_StoreLocator_Block_Adminhtml_Location_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        if (Mage::registry('location_data')) {
            ...
            $querySTring .= '/region_id/'.$data['region_id'].'/region/'.$data['region'];
        }
	...
	$country = $fieldset->addField('country', 'select', array(
         ...
         */
        $country->setAfterElementHtml("<div id=\"state\"></div><script type=\"text/javascript\">getstate($('country'));
            function getstate(selectElement){ 
                var reloadurl = '". $this
                 ->getUrl('ustorelocatoradmin/adminhtml_location/state') . "country/' + selectElement.value+'".$querySTring."';
        ...
        /*****START:: Added by bijal to on/off store in frontend*****/
