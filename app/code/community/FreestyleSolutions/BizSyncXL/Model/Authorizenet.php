...
class FreestyleSolutions_BizSyncXL_Model_Authorizenet extends Mage_Paygate_Model_Authorizenet
{
    /**
    ...
    {
	//Mage::log("In FreestyleSolutions_BizSyncXL_Model_Authorizenet::_registerCard");
