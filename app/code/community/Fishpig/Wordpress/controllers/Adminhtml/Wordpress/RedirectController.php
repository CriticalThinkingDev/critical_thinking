...
class Fishpig_Wordpress_Adminhtml_Wordpress_RedirectController extends Fishpig_Wordpress_Controller_Adminhtml_Abstract
{
	/**
	...
	public function indexAction()
	{
		try {
			...
			if (!Mage::helper('wordpress/database')->isConnected() || !Mage::helper('wordpress/database')->isQueryable()) {
				...
				$this->_redirect('adminhtml/wordpress/autologin', array('redirect_to' => base64_encode($this->_getDestinationPage())));
				return;
			}
		}
	}
