...
foreach($Ids as $id){
    ...
    if(count($reviews)){
        $associatedProducts = '';
        $associatedProducts = $product->getTypeInstance(true)->getChildrenIds($product->getId());
        $associatedProducts =reset($associatedProducts);
        //$associatedProducts = key($associatedProducts);
        //$associatedProducts = $product->getTypeInstance(true)->getAssociatedProducts($product);
      //  echo '<pre>'; print_r($associatedProducts); echo '</pre>';exit;
