...
Pluit.Carousel.Element = Class.create({
  ...
  initViewport: function() {
    ...
    this.elViewport.observe('over', this.onViewportClick.bindAsEventListener(this));
  },
  ...
  initNavigation: function() {
    ...
    this.elNav.observe('over', this.onNavClick.bindAsEventListener(this));
  },
  ...
  checkPageNo: function(pageNo, curPageNo) {
    ...
    if (isPrevious) {
         if (this.maxPageNo+2 < pageNo && this.elCarousel.id == "carousel-2") {
        ...
        // alert(this.elCarousel);
      if (pageNo > this.maxPageNo-2 && this.elCarousel.id == "carousel-2"){      
        if (this.options.circular) {
          return 1;
        } else {
          return this.maxPageNo;
